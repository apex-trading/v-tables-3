...
module.exports = function(data, e) {
  ...
  // // if a custom filter is applied and matches the column name, return the data
    ...
    function(row, index) {
      ...
      this.filterableColumns.forEach(
        function(column) {
          ...
          // if a custom filter is applied and matches the column name, return the data. It will have already been filtered.
